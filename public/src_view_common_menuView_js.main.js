 ...
 */
(self["webpackChunklistapp"] = self["webpackChunklistapp"] || []).push([["src_view_common_menuView_js"],{
...
/***/ "./src/view/common/menuView.js":
/*!*************************************!*\
  !*** ./src/view/common/menuView.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"show\": () => (/* binding */ show),\n/* harmony export */   \"hide\": () => (/* binding */ hide)\n/* harmony export */ });\n/* harmony import */ var _canvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas */ \"./src/view/common/canvas.js\");\n//メニュー\n\n\nconst speed = 20;\nconst menu = document.getElementsByClassName(\"menu-button\");\nconst menuNum = menu.length;\n\nconst show = () => {\n    (0,_canvas__WEBPACK_IMPORTED_MODULE_0__.showAnimation)();\n    document.getElementById(\"menu\").style.display = 'block';\n    let count = 0;\n    const show = () => {\n        for (let i = 0; i < menuNum; i++){\n            menu[i].style.opacity =  count / speed;\n        }\n        \n        count++;\n        if (count <= speed) {\n            requestAnimationFrame(show);\n        }\n    }\n    show();\n}\n\nconst hide = () => {\n    ;(0,_canvas__WEBPACK_IMPORTED_MODULE_0__.hideAnimation)();\n    let count = 0;\n    const hide = () => {\n        for (let i = 0; i < menuNum; i++){\n            menu[i].style.opacity = 1 - count / speed;\n        }\n        count++;\n        if (count <= speed) {\n            requestAnimationFrame(hide);\n        } else {\n            document.getElementById(\"menu\").style.display = 'none';\n        }\n    }\n    hide();\n}\n\n//# sourceURL=webpack://listapp/./src/view/common/menuView.js?");
